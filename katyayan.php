...
<head>
  ...
  <title>Dr. Katyayan Mishra – Apex Health Care</title>
...
<div class="page-banner">
  ...
  <div class="container page-banner-content">
    <h1>Dr. Katyayan Mishra</h1>
    <div class="breadcrumb-wrap">
      <a href="index.php">Home</a>
      <span class="sep">›</span>
      <a href="doctors.php">Doctors</a>
      <span class="sep">›</span>
      <span class="current">Dr. Katyayan Mishra</span>
    </div>
  </div>
</div>
    ...
    <div class="row g-5">
      <div class="col-lg-4" data-aos="fade-right">
        <div style="background:#fff; border-radius:15px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,0.05); text-align:center;">
          <img src="assets/img/katyayan.jpg" alt="Dr. Katyayan Mishra" style="width:100%; height:350px; object-fit:cover;">
          <div style="padding:30px;">
            <h3 style="color:var(--secondary-color); font-weight:700;">Dr. Katyayan Mishra</h3>
            <span style="color:var(--primary-color); font-weight:600; display:block; margin-bottom:20px;">Dermatologist</span>
      ...
      <div class="col-lg-8" data-aos="fade-left" data-aos-delay="100">
        <div style="background:#fff; padding:40px; border-radius:15px; box-shadow:0 10px 30px rgba(0,0,0,0.05);">
          <h3 style="color:var(--secondary-color); font-weight:700; margin-bottom:20px;"><i class="fas fa-user-md" style="color:var(--primary-color);"></i> About Dr. Katyayan Mishra</h3>
          <p style="color:#666; line-height:1.8;">Dr. Katyayan Mishra is a highly experienced Dermatologist dedicated to providing the best possible care to patients. With years of extensive training and practice, Dr. Katyayan Mishra brings a wealth of knowledge to Apex Health Care.</p>
          ...
          <ul style="color:#666; line-height:1.8; list-style-type:none; padding-left:0;">
            ...
            <li><i class="fas fa-check-circle" style="color:var(--primary-color); margin-right:10px;"></i> Advanced Fellowship in Dermatologist</li>
